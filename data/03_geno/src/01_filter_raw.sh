...
# Get plink files
plink --vcf data/filtered/cpepo_ld_filt.vcf  --double-id --make-bed --out data/filtered/cpepo

plink --vcf data/filtered/cmoschata_ld_filt.vcf  --double-id --make-bed --out data/filtered/cmoschata

plink --vcf data/filtered/cmaxima_ld_filt.vcf  --double-id --make-bed --out data/filtered/cmaxima

# Subset plink files to cult and no cult
plink --bfile data/filtered/cpepo --remove ../01_meta/data/cpepo_cultivars.txt --make-bed --out data/filtered/cpepo_admix_nocult

plink --bfile data/filtered/cpepo  --double-id --keep ../01_meta/data/cpepo_cultivars.txt --make-bed --out data/filtered/cpepo_admix_cult

plink --bfile data/filtered/cmoschata  --double-id --remove ../01_meta/data/cmoschata_cultivars.txt --make-bed --out data/filtered/cmoschata_admix_nocult

plink --bfile data/filtered/cmoschata --double-id --keep ../01_meta/data/cmoschata_cultivars.txt --make-bed --out data/filtered/cmoschata_admix_cult

plink --bfile data/filtered/cmaxima  --double-id --remove ../01_meta/data/cmaxima_cultivars.txt --make-bed --out data/filtered/cmaxima_admix_nocult

plink --bfile data/filtered/cmaxima  --double-id --keep ../01_meta/data/cmaxima_cultivars.txt --make-bed --out data/filtered/cmaxima_admix_cult
...
-FilterSiteBuilderPlugin -siteMinAlleleFreq 0.05 -removeMinorSNPStates true -siteMinCount 427 -endPlugin \
