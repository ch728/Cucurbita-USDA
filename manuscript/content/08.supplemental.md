...
![Spatial distribution of filtered markers for **panel a.** *C. pepo*, **panel b.** *C. moschata*, and **panel c.** *C. maxima*.](../../supplemental/01_supfig.png){#fig:mrk}

![Cross-validation error  plots used to pick the optimum K value for admixture analysis. The K value that balances minimizing cross-validation error and parsimony, and thus chosen for the final analysis, is labeled with a red point.](../../supplemental/02_supfig.png){#fig:cv}
...
![ Histograms of continuous and ordinal traits for **panel a.** *C. pepo*, **panel b.** *C. moschata*, and **panel c.** *C. maxima*.](../../supplemental/04_supfig.png){#fig:pheno} 
...
Table: Description of traits used for association analysis {#tbl:trait_description}


![Quantile-quantile plots matching GWAS results. **Panel a.** *C. pepo*, **panel b.** *C moschata*, and **panel c.** *C. maxima* ](../../supplemental/05_subfig.png){#fig:qq} 
