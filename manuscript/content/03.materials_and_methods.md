...
### GWAS
Variant data were imputed prior to association analysis. 
...
The GENESIS [@doi:10.1093/bioinformatics/btz567] R package, which can model both binary and continuous traits, was used for association analysis. 
