...
anno <- data.frame(x=c(3,6,6),
		   y=c(0.38837, 0.4712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124471244712447124, 0.41559),
